...
export const MASTER_CATEGORIES: PrimaryCategory[] = [
  ...
  },
  {
    ...
    name: 'Bottoms',
    slug: 'bottoms',
    image: '/assets/off-white-copper-leaf-handpainted-coord-set-4.webp',
    subtitle: 'THE PERFECT PAIR',
    description: 'Flared palazzos, tailored trousers, dhoti pants, and traditional salwars to complete your look.',
    subcategories: [
      'Flared Palazzos',
      'Pants & Trousers',
      'Ethnic Skirts',
